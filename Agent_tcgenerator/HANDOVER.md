...
**Mac (터미널):**
```bash
ROOT="/Users/사용자명/Agent_tcgenerator"
...
**Windows (PowerShell):**
```powershell
$ROOT = "C:\Users\사용자명\Agent_tcgenerator"
$PHASE = "phase3-mobile-mockup"
$REVIEW = "$ROOT\$PHASE\_workspace\05_review"
$TC_DIR = "$ROOT\$PHASE\_workspace\04_tc"
...
Git 저장소에서 `Agent_tcgenerator`과 **같은 부모 폴더**에 `tc.automation`이 함께 존재한다.

```
repo/
├── Agent_tcgenerator/   ← 이 폴더 (Claude Code 파이프라인)
